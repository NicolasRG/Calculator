...
public class basics extends JFrame{
	...
	public basics(){
		...
		Border operBorder = BorderFactory.createLineBorder(Color.blue);
		...
		//second button to close the screen
		...
		label4 = new JLabel("How would you like your answer to be formatted");
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource() == button1){
				...
				try{
					...
					JOptionPane.showMessageDialog(basics.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
				...
				if(dollarSign.isSelected()) {
					...
					JOptionPane.showMessageDialog(basics.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
				...
				JOptionPane.showMessageDialog(basics .this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
				
				}
					
			}
			
			//put the colse button here
